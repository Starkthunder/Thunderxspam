...
from AltBots.data import RAID, REPLYRAID, ALTRON, MRAID, SRAID, CRAID, THUNDER
...
async def raid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in ALTRON:
                await e.reply("ɴᴏ, ᴛʜɪꜱ ɪꜱ ᴛʜᴜɴᴅᴇʀxꜱᴩᴀᴍ ᴏᴡɴᴇʀ.")
            elif uid == OWNER_ID:
...
async def drraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply("»Ok ʀᴇᴘʟʏ ʀᴀɪᴅ ᴅᴇ-ᴀᴄᴛɪᴠᴀᴛᴇᴅ !! ✅")
        except NameError:
